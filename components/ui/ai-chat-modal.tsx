                ...
                <div className={`relative rounded-2xl px-5 py-3 max-w-[80%] whitespace-pre-line break-words shadow-sm ${msg.role === "user" ? "bg-primary text-primary-foreground" : "bg-card dark:bg-zinc-800/80 text-foreground border border-border/50"}`}>
                  {msg.role === "assistant" ? (
                    <>
                      ...
                      <button
                        className="absolute bottom-5 -right-10 -translate-x-15 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 p-2 rounded-lg transition-all duration-150 ease-out hover:scale-110"
                    ...
                    <>
                      ...
                      {msg.content}
                      <button
                        className="absolute bottom-3 -left-10 translate-x-15 opacity-0 group-hover:opacity-100 group-hover:translate-x-0 p-2 rounded-lg transition-all duration-150 ease-out hover:scale-110"
